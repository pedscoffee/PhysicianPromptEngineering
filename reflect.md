...
const DATA = {
    frameworks: [
        ...
        { id: "psychiatric", label: "Psychiatric / Psychosocial", def: "Mental health conditions or psychosocial factors that manifest with physical symptoms.", q: "How might psychological, social, or behavioral factors be contributing? Is this somatization or functional?" }
    ],
    biases: [
