...
title: "Module 3: Cardiovascular & Respiratory"
course: newborn-exam
module_number: 3
permalink: /courses/newborn-exam/module-3/
description: "Evaluate heart murmurs, recognize respiratory distress, and assess cyanosis"
duration: "60 minutes"
difficulty: "intermediate"
next_module: "/courses/newborn-exam/module-4/"
---
...
**Silverman Score** (useful tool to quantify severity):
Scores 0-10 (higher = more distress)
...
<div class="course-exercise" id="nb_m3e1">

  <div class="exercise-header">
    <h3 class="exercise-title">Exercise 3.1: Heart Murmurs - Identification and Significance</h3>
  ...
  <div class="exercise-goal">
    ...
    <p>Review clinical scenarios describing newborns with murmurs. For each case, characterize the murmur, assess likelihood of innocent versus pathological findings, identify any concerning associated features, and recommend appropriate diagnostic steps.</p>
  </div>

  <details class="exercise-transcript">
    <summary>📋 View Clinical Cases with Murmurs</summary>
    <div class="transcript-content" id="transcript-content-nb-m3e1">Loading cases...</div>
  </details>

  <div class="exercise-editor">
    <label for="student-prompt-nb-m3e1">Your Assessment:</label>
    <textarea id="student-prompt-nb-m3e1" class="student-prompt" rows="16" placeholder="For EACH case, provide:

1. MURMUR CHARACTERISTICS:
   - Timing (systolic, diastolic, continuous)
   - Location and radiation
   - Quality (musical, blowing, harsh, vibratory)
   - Grade (1-6)

2. INNOCENT vs PATHOLOGICAL ASSESSMENT:
   - Is this likely innocent or concerning?
   - What features support your assessment?

3. ASSOCIATED FINDINGS:
   - Heart sounds: Are S1 and S2 normal?
   - Pulses: Compare brachial and femoral
   - Signs of heart failure: Hepatomegaly, feeding difficulty, tachypnea
   - Cyanosis present or absent
   - Any arrhythmias

4. DIFFERENTIAL DIAGNOSIS:
   - If innocent, what transitional finding is this?
   - If concerning, what cardiac lesions come to mind?

5. WORKUP RECOMMENDATIONS:
   - Is echocardiography needed?
   - What would you tell the parents?
   - What is the urgency level?

Be systematic and thorough in your analysis!"></textarea>
    <div class="editor-hints">
      💡 Tips: Remember - diastolic murmurs are always concerning. Innocent murmurs are usually soft (grades 1-2), systolic, no thrill, no associated signs of disease. Consider transitional physiology in first days of life.
    </div>
  ...
  <div class="exercise-feedback" style="display: none;">
    ...
    <div class="exercise-actions">
      ...
      <button class="btn-next-exercise" onclick="document.getElementById('nb_m3e2').scrollIntoView({behavior: 'smooth'});">Next Exercise →</button>
    </div>
  </div>
...
<script>
  (function() {
    ...
    const exerciseConfig = exercises.newborn_m3e1;
    const scenario = scenarios[exerciseConfig.scenario];

    document.getElementById('transcript-content-nb-m3e1').textContent = scenario.scenario;

    const exercise = new NewbornExercise('nb_m3e1', {
      ...exerciseConfig,
...
<div class="course-exercise" id="nb_m3e2">

  <div class="exercise-header">
    <h3 class="exercise-title">Exercise 3.2: Respiratory Patterns and Findings</h3>
    <div class="exercise-meta">
      <span class="exercise-difficulty difficulty-intermediate">Intermediate</span>
      <span class="exercise-time">⏱ 20 minutes</span>
    </div>
  ...
  <div class="exercise-goal">
    <h3>Your Challenge</h3>
    <p>Review clinical scenarios and descriptions of newborns with different respiratory patterns. Assess respiratory rate, work of breathing, identify signs of distress, suggest differential diagnoses, and determine urgency of intervention.</p>
  </div>

  <details class="exercise-transcript">
    <summary>📋 View Respiratory Cases</summary>
    <div class="transcript-content" id="transcript-content-nb-m3e2">Loading cases...</div>
  </details>

  <div class="exercise-editor">
    <label for="student-prompt-nb-m3e2">Your Assessment:</label>
    <textarea id="student-prompt-nb-m3e2" class="student-prompt" rows="16" placeholder="For EACH case, provide:

1. RESPIRATORY RATE AND PATTERN:
   - Count: Is it normal (30-60), tachypneic (>60), or bradypneic (<30)?
   - Pattern: Regular, periodic, irregular, or abnormal?

2. WORK OF BREATHING ASSESSMENT:
   - Retractions present? (intercostal, subcostal, suprasternal)
   - Nasal flaring or grunting?
   - Use of accessory muscles?
   - Overall severity: Mild, moderate, or severe distress

3. ASSOCIATED FINDINGS:
   - Cyanosis: Absent, peripheral only, or central?
   - Breath sounds: Normal, decreased, or abnormal (crackles, wheezes)?
   - Color and perfusion: Pink, pale, mottled?
   - Oxygen saturation if provided

4. DIFFERENTIAL DIAGNOSIS:
   - What is the most likely diagnosis?
   - What other conditions could present this way?
   - Is this pulmonary, cardiac, or other cause?

5. SEVERITY AND URGENCY:
   - Is this infant well, mild distress, moderate, or critical?
   - Does this need immediate intervention (oxygen, support)?

6. MANAGEMENT RECOMMENDATIONS:
   - What would be your immediate actions?
   - What monitoring or testing is needed?

Be comprehensive and systematic!"></textarea>
    <div class="editor-hints">
      💡 Tips: Assess WORK of breathing, not just rate. Grunting is a compensatory mechanism. Retractions indicate significant respiratory effort. Consider common newborn conditions like TTN, RDS, and meconium aspiration.
    </div>
    <div class="hint-display"></div>
    <div class="error-message"></div>
    <button class="btn-run-exercise">Submit Assessment</button>
  ...
  <div class="exercise-feedback" style="display: none;">
    ...
    <div class="exercise-actions">
      <button class="btn-retry">Try Again</button>
      <button class="btn-next-exercise" onclick="document.getElementById('nb_m3e3').scrollIntoView({behavior: 'smooth'});">Next Exercise →</button>
    </div>
  </div>
...
<script>
  (function() {
    ...
    const exerciseConfig = exercises.newborn_m3e2;
    const scenario = scenarios[exerciseConfig.scenario];

    document.getElementById('transcript-content-nb-m3e2').textContent = scenario.scenario;

    const exercise = new NewbornExercise('nb_m3e2', {
      ...exerciseConfig,
      scenario: scenario.scenario,
      expectedFindings: scenario.expected_findings
    });
...
<div class="course-exercise" id="nb_m3e3">

  <div class="exercise-header">
    <h3 class="exercise-title">Exercise 3.3: Cyanosis Evaluation</h3>
    <div class="exercise-meta">
  ...
  <div class="exercise-goal">
    <h3>Your Challenge</h3>
    <p>Evaluate cases with cyanosis. Differentiate central from peripheral cyanosis, develop comprehensive differential diagnoses, recommend appropriate diagnostic workup including hyperoxia testing, and determine urgency of intervention.</p>
  </div>

  <details class="exercise-transcript">
    <summary>📋 View Cyanosis Cases</summary>
    <div class="transcript-content" id="transcript-content-nb-m3e3">Loading cases...</div>
  </details>

  <div class="exercise-editor">
    <label for="student-prompt-nb-m3e3">Your Assessment:</label>
    <textarea id="student-prompt-nb-m3e3" class="student-prompt" rows="18" placeholder="For EACH case, provide:

1. CYANOSIS CLASSIFICATION:
   - Central (lips, tongue, mucous membranes) or peripheral (hands/feet only)?
   - Distribution pattern and timing of onset

2. CLINICAL CONTEXT:
   - Age/gestational age of infant
   - Associated symptoms: Respiratory distress, feeding difficulty, poor perfusion?
   - Cardiac findings: Murmur, abnormal pulses, hepatomegaly?
   - Respiratory findings: Work of breathing, breath sounds?

3. PULMONARY vs CARDIAC DISTINCTION:
   - What features suggest pulmonary cause?
   - What features suggest cardiac cause?
   - Based on evidence, which is more likely?

4. HYPEROXIA TEST PREDICTION:
   - If done, what would we expect?
   - Would SpO2 improve dramatically or remain low?

5. DIFFERENTIAL DIAGNOSIS:
   - If pulmonary: List likely diagnoses (RDS, TTN, aspiration, pneumonia, PPHN)
   - If cardiac: List congenital heart lesions that could present this way
   - Other causes: Hematologic, metabolic?

6. DIAGNOSTIC WORKUP:
   - What imaging would you order? (CXR, echo, etc.)
   - Would hyperoxia test help?
   - Is blood gas needed?
   - Timing: What's the urgency?

7. IMMEDIATE MANAGEMENT:
   - Oxygen: Start immediately or hold?
   - Monitoring: What equipment needed?
   - Consultations: Pediatrics, cardiology, NICU?
   - Treatments: PGE1, surfactant, support?

This is a critical skill - be thorough!"></textarea>
    <div class="editor-hints">
      💡 Tips: ALWAYS check mucous membranes - if blue inside mouth = CENTRAL CYANOSIS = CONCERNING. Peripheral cyanosis in hands/feet with pink lips/trunk is often benign. Cyanosis that doesn't improve with 100% oxygen suggests cardiac disease (right-to-left shunt). Cyanotic heart disease is an EMERGENCY.
    </div>
    <div class="hint-display"></div>
    <div class="error-message"></div>
    <button class="btn-run-exercise">Submit Assessment</button>
  ...
  <div class="exercise-feedback" style="display: none;">
    ...
    <div class="exercise-actions">
      <button class="btn-retry">Try Again</button>
      <a href="/courses/newborn-exam/module-4/" class="btn-next-exercise">Continue to Module 4 →</a>
    </div>
  </div>
...
<script>
  (function() {
    ...
    const exerciseConfig = exercises.newborn_m3e3;
    const scenario = scenarios[exerciseConfig.scenario];

    document.getElementById('transcript-content-nb-m3e3').textContent = scenario.scenario;

    const exercise = new NewbornExercise('nb_m3e3', {
      ...exerciseConfig,
      scenario: scenario.scenario,
      expectedFindings: scenario.expected_findings
    });
...
✅ Systematic cardiac auscultation techniques
✅ Characterization of murmurs and differentiation of innocent from pathological findings
✅ Understanding of transitional circulation and its clinical significance
✅ Recognition of respiratory distress and work of breathing assessment
✅ Comprehensive cyanosis evaluation and emergency recognition
✅ Knowledge of when urgent specialist consultation is needed
...
<div style="text-align: center; margin: 3rem 0;">
  <a href="/courses/newborn-exam/module-4/" class="btn-primary" style="display: inline-block; padding: 1rem 2rem; font-size: 1.125rem; background: #2563eb; color: white; text-decoration: none; border-radius: 0.5rem; font-weight: 600;">Continue to Module 4 →</a>
</div>
