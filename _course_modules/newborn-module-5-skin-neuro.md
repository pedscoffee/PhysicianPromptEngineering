...
title: "Module 5: Skin & Neurological"
course: newborn-exam
module_number: 5
permalink: /courses/newborn-exam/module-5/
description: "Differentiate newborn rashes and perform comprehensive neurological assessment"
duration: "75 minutes"
difficulty: "advanced"
---
...
**Parent Counseling:**
"These little red bumps are a very common, temporary newborn rash. They're sterile, nothing to treat, and will disappear on their own in about a week or two. This isn't an infection and doesn't indicate any health problem."

**Clinical Pearl:**
Can be confirmed by Wright staining of pustule contents showing eosinophils if diagnosis uncertain, but rarely needed.
...
**Parent Counseling:**
"These are tiny blocked oil glands on baby's skin. They're completely normal and will clear up on their own in a few weeks. Don't squeeze them - they'll go away faster if left alone."

**Tip for Parents:**
Milia are not whiteheads and shouldn't be treated like acne. Using moisturizers or any treatments is unnecessary and potentially harmful.
...
**Parent Counseling:**
"This is a flat, gray-blue mark on the skin that's very common in babies. It's completely harmless and will fade over time. This is not a bruise or indication of injury."

**Important Clinical Note:**
Because these can resemble bruises, document their location carefully in medical records. This helps prevent misunderstanding if questioned about potential abuse. The flat, non-blanching nature and typical locations (sacrum, buttocks) help differentiate from traumatic bruising.
...
**Parent Counseling:**
"Your baby has this waxy coating because it spent months in amniotic fluid. It's protective and healthy - we don't need to wash it off. It will come off on its own as your baby's skin adjusts to air."
...
**Urgency:**
**REQUIRES IMMEDIATE ACTION - TREAT EMPIRICALLY**
...
**Clinical Pearl:**
Even with maternal history of HSV, risk of transmission is low if mother on prophylaxis or has no prodromal symptoms at delivery. However, always maintain high suspicion for any vesicular rash in first 2-4 weeks of life.
...
**Parent Counseling:**
"This vascular birthmark will likely grow over the next several months, but most fade naturally over time. We'll monitor it carefully. Treatment depends on size, location, and growth rate."
...
**Parent Counseling:**
"These are light pink marks on the skin that are very common in newborns. Most fade on their own within the first year or two. If they persist, there are cosmetic options available, but they're completely harmless."
...
2. General behavior and state
3. Cranial nerves
4. Motor tone and posture
5. Primitive reflexes
6. Movement and strength
7. Sensation (limited testing)
...
**Clinical Pearl:**
Normal grasp reflex is surprising strong. Infant unable to maintain grip may indicate significant weakness.
...
**Parent Counseling:**
"Your baby has an injury to the nerves that control arm movement. This happened during delivery. Most babies recover completely on their own over weeks to months. We'll monitor the movement closely."
...
2. **Stop seizure** - Phenobarbital or phenytoin
3. **Evaluate** - Labs (glucose, calcium, magnesium, blood/CSF cultures)
4. **Investigate** - Imaging if indicated
5. **Treat cause** - Address underlying condition
...
## Exercise 5.1: Newborn Skin Findings - Normal vs Pathological

Let's practice differentiating benign newborn skin findings from concerning conditions that require intervention.

<div class="course-exercise" id="nb_m5e1">

  <div class="exercise-header">
    <h3 class="exercise-title">Exercise 5.1: Newborn Skin Findings Assessment</h3>
  ...
  <div class="exercise-goal">
    ...
    <p>Review descriptions of various skin findings in newborns. For each finding, identify it correctly, determine whether it's benign or concerning, explain the expected course, know when to worry or investigate further, and provide appropriate parent counseling.</p>
  </div>

  <details class="exercise-transcript">
    <summary>View Skin Finding Descriptions</summary>
    <div class="transcript-content" id="transcript-content-nb-m5e1">Loading cases...</div>
  </details>

  <div class="exercise-editor">
    <label for="student-prompt-nb-m5e1">Your Assessment:</label>
    <textarea id="student-prompt-nb-m5e1" class="student-prompt" rows="15" placeholder="For EACH skin finding, provide:

1. IDENTIFICATION: What is this finding called?

2. CLASSIFICATION: Is this benign/normal, a warning sign, or definitely pathological?

3. NATURAL HISTORY: What is the expected course and timeline?

4. REASSURANCE vs CONCERN: Can you reassure parents, or does this need investigation?

5. MANAGEMENT: Any treatment needed or monitoring required?

6. RED FLAGS: What signs would change this from benign to concerning?

7. PARENT COUNSELING: How would you explain this to parents in simple terms?

Be thorough - think about each finding systematically!"></textarea>
    <div class="editor-hints">
      Tip: Remember benign findings like milia, erythema toxicum, and Mongolian spots are common and don't need treatment. Vesicles, extensive petechiae, or bullae warrant further investigation.
    </div>
  ...
  <div class="exercise-feedback" style="display: none;">
    ...
    <div class="exercise-actions">
      ...
      <button class="btn-next-exercise" onclick="document.getElementById('nb_m5e2').scrollIntoView({behavior: 'smooth'});">Next Exercise →</button>
    </div>
  </div>
...
<script>
  (function() {
    ...
    const exerciseConfig = exercises.newborn_m5e1;
    const scenario = scenarios[exerciseConfig.scenario];

    document.getElementById('transcript-content-nb-m5e1').textContent = scenario.scenario;

    const exercise = new NewbornExercise('nb_m5e1', {
      ...exerciseConfig,
...
<div class="course-exercise" id="nb_m5e2">

  <div class="exercise-header">
    <h3 class="exercise-title">Exercise 5.2: Primitive Reflexes Assessment</h3>
    <div class="exercise-meta">
  ...
  <div class="exercise-goal">
    <h3>Your Challenge</h3>
    <p>Review video descriptions of primitive reflex testing in different scenarios. For each reflex, identify what's being tested, determine if the response is normal or abnormal, know the expected developmental timeline, and understand the clinical significance of abnormalities.</p>
  </div>

  <details class="exercise-transcript">
    <summary>View Reflex Testing Cases</summary>
    <div class="transcript-content" id="transcript-content-nb-m5e2">Loading cases...</div>
  </details>

  <div class="exercise-editor">
    <label for="student-prompt-nb-m5e2">Your Assessment:</label>
    <textarea id="student-prompt-nb-m5e2" class="student-prompt" rows="16" placeholder="For EACH reflex scenario, provide:

1. REFLEX IDENTIFICATION: Which primitive reflex is being tested?

2. NORMAL RESPONSE: What does a normal response look like?

3. YOUR ASSESSMENT: Is this response normal or abnormal? Describe what you see.

4. DEVELOPMENTAL TIMELINE: When should this reflex appear and disappear?

5. BILATERAL SYMMETRY: Are both sides responding equally? Any asymmetry?

6. SIGNIFICANCE: What does abnormality suggest?
   - Absent reflex: What could cause this?
   - Asymmetric: What does this indicate?
   - Exaggerated/Persistent: What concerns you?

7. NEXT STEPS: Would you do anything based on this finding?

Reference the 'teaching points' if you need clarification on normal variants!"></textarea>
    <div class="editor-hints">
      Tip: Normal asymmetric Moro suggests possible brachial plexus injury. Absent Moro in term infant is concerning. Remember developmental timelines - which reflexes are normally present at what ages.
    </div>
    <div class="hint-display"></div>
    <div class="error-message"></div>
    <button class="btn-run-exercise">Submit Assessment</button>
  ...
  <div class="exercise-feedback" style="display: none;">
    ...
    <div class="exercise-actions">
      <button class="btn-retry">Try Again</button>
      <button class="btn-next-exercise" onclick="document.getElementById('nb_m5e3').scrollIntoView({behavior: 'smooth'});">Next Exercise →</button>
    </div>
  </div>
...
<script>
  (function() {
    ...
    const exerciseConfig = exercises.newborn_m5e2;
    const scenario = scenarios[exerciseConfig.scenario];

    document.getElementById('transcript-content-nb-m5e2').textContent = scenario.scenario;

    const exercise = new NewbornExercise('nb_m5e2', {
      ...exerciseConfig,
      scenario: scenario.scenario,
      expectedFindings: scenario.expected_findings
    });
...
<div class="course-exercise" id="nb_m5e3">

  <div class="exercise-header">
    <h3 class="exercise-title">Exercise 5.3: Tone and Comprehensive Neurological Exam</h3>
    <div class="exercise-meta">
      <span class="exercise-difficulty difficulty-advanced">Advanced</span>
      <span class="exercise-time">⏱ 25 minutes</span>
    </div>
  ...
  <div class="exercise-goal">
    <h3>Your Challenge</h3>
    <p>Review comprehensive neurological examination cases with detailed descriptions and images. Perform a complete assessment of tone, symmetry, alertness, and neurological function. Identify concerning findings, develop differential diagnoses, and recommend appropriate workup and referral.</p>
  </div>

  <details class="exercise-transcript">
    <summary>View Comprehensive Neurological Cases</summary>
    <div class="transcript-content" id="transcript-content-nb-m5e3">Loading cases...</div>
  </details>

  <div class="exercise-editor">
    <label for="student-prompt-nb-m5e3">Your Assessment:</label>
    <textarea id="student-prompt-nb-m5e3" class="student-prompt" rows="18" placeholder="For EACH case, provide:

1. OVERALL IMPRESSION: Does this infant appear neurologically intact or are there concerns?

2. TONE ASSESSMENT:
   - Type: Hypotonic, normal, or hypertonic?
   - Axial vs limb involvement?
   - Symmetric or asymmetric?

3. MOVEMENT AND ACTIVITY:
   - Quantity and quality of movement?
   - Symmetric or asymmetric?
   - Any concerning patterns (tremor, stiffness, flaccidity)?

4. ALERTNESS AND RESPONSIVENESS:
   - Appropriate for state?
   - Responsive to stimuli?
   - Any decreased consciousness?

5. PRIMITIVE REFLEXES: (if described)
   - Normal or abnormal?
   - Symmetric or asymmetric?

6. ABNORMALITY IDENTIFICATION: What specific findings concern you? Why?

7. DIFFERENTIAL DIAGNOSIS: What conditions could cause these findings?
   - Consider: HIE, birth trauma, infection, metabolic, genetic

8. RECOMMENDED WORKUP:
   - Labs? Imaging? Specialist consultation?

9. IMMEDIATE MANAGEMENT: Any interventions needed?

Think systematically - tone first, then movement, then detailed findings!"></textarea>
    <div class="editor-hints">
      Tip: Hypotonia with poor suck/cry is concerning. Asymmetric findings suggest localized injury. Remember normal flexor tone in newborns - excessive extension is abnormal. Consider seizures in apparently jittery infants.
    </div>
    <div class="hint-display"></div>
    <div class="error-message"></div>
    <button class="btn-run-exercise">Submit Assessment</button>
  ...
  <div class="exercise-feedback" style="display: none;">
    ...
    <div class="exercise-actions">
      <button class="btn-retry">Try Again</button>
      <button class="btn-congratulations" onclick="document.getElementById('course-completion').scrollIntoView({behavior: 'smooth'});">View Course Completion →</button>
    </div>
  </div>
...
<script>
  (function() {
    ...
    const exerciseConfig = exercises.newborn_m5e3;
    const scenario = scenarios[exerciseConfig.scenario];

    document.getElementById('transcript-content-nb-m5e3').textContent = scenario.scenario;

    const exercise = new NewbornExercise('nb_m5e3', {
      ...exerciseConfig,
      scenario: scenario.scenario,
      expectedFindings: scenario.expected_findings
    });
...
<div id="course-completion" style="text-align: center; margin: 4rem 0;">
  <h2 style="font-size: 2.5rem; color: #059669;">Congratulations!</h2>
  <p style="font-size: 1.25rem; color: #666; margin: 1.5rem 0;">You've successfully completed the Newborn Pediatric Physical Exam Course!</p>
</div>
...
**Always Prioritize:**
1. **Red reflex examination** - Never skip; potential vision-threatening or life-threatening conditions
2. **Feeding assessment** - Safe nutrition is essential for newborn survival and growth
3. **Neurological assessment** - Identifies birth injuries and metabolic emergencies
4. **Infection recognition** - Newborn sepsis can progress rapidly
5. **Trust your gestalt** - If baby "doesn't look right," investigate
...
1. **Be Systematic** - Use the structure learned in this course for every exam
2. **Document Thoroughly** - Clear, specific documentation is essential
3. **Develop Your Eye** - Pattern recognition improves with experience
4. **Ask for Feedback** - Mentors can help refine your technique
5. **Stay Current** - Continue learning throughout your career
...
<div style="text-align: center; margin: 3rem 0;">
  <a href="/courses/newborn-exam/" class="btn-primary" style="display: inline-block; padding: 1rem 2rem; font-size: 1.125rem; background: #059669; color: white; text-decoration: none; border-radius: 0.5rem; font-weight: 600;">Return to Course Home</a>
</div>

<div style="background: #dcfce7; border-left: 4px solid #059669; padding: 2rem; border-radius: 0.5rem; margin: 3rem 0; text-align: center;">
  <h3 style="margin-top: 0; color: #166534;">Course Complete!</h3>
  <p style="color: #166534; font-size: 1.1rem; margin: 0;">You are now prepared to provide comprehensive, expert newborn physical examinations. Congratulations on your achievement!</p>
</div>
