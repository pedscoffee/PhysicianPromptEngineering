...
title: "Module 4: Abdomen, Genitourinary, & Musculoskeletal"
course: newborn-exam
module_number: 4
permalink: /courses/newborn-exam/module-4/
description: "Master abdominal exam, hip screening, and musculoskeletal assessment"
duration: "60 minutes"
difficulty: "intermediate"
next_module: "/courses/newborn-exam/module-5/"
---
...
**Sequence:**
1. Inspection for shape, color, distension, visible peristalsis
2. Auscultation for bowel sounds
3. Palpation (superficial, then deep)
4. Assessment of liver, spleen, kidneys
...
**Technique:**
1. Infant supine on firm surface
2. Hip and knee flexed to 90 degrees
3. Abduct hip (move femur away from midline) while lifting femoral head anteriorly
4. Listen and feel for **"clunk"** as head reduces into socket
5. Clunk is palpable (not just audible)
...
**Technique:**
1. Infant supine, hip and knee flexed 90 degrees
2. Abduction: Move knee toward floor while internally rotating femur
3. Press distal femur posteriorly with thumb
4. Feel for **"clunk"** as femoral head dislocates posteriorly
5. Reverse maneuver to reduce hip
...
**Inspection:**
1. Examine infant prone (or on side if not cooperative)
2. Assess: Midline structures, skin dimples/pits, hair patches, hemangiomas
3. Palpate along entire spine from cervical to sacral region
4. Assess for: Step-offs, abnormal curvature, masses
...
**General Approach:**
1. Inspect all four extremities for symmetry, color, swelling
2. Palpate for: Fractures, dislocations, masses
3. Assess passive range of motion
4. Check for: Digit abnormalities, skin findings
5. Assess tone and movement bilaterally
...
<div class="course-exercise" id="nb_m4e1">

  <div class="exercise-header">
    <h3 class="exercise-title">Exercise 4.1: Abdominal Exam - Umbilicus, Hernias, and Masses</h3>
  ...
  <div class="exercise-goal">
    ...
    <p>Examine images showing various abdominal findings in newborns. Assess each finding by identifying what you see, determining if it's benign or concerning, recognizing when surgical consultation is needed, understanding the expected course, and providing appropriate parent education.</p>
  </div>

  <details class="exercise-transcript">
    <summary>View Clinical Cases</summary>
    <div class="transcript-content" id="transcript-content-nb-m4e1">Loading cases...</div>
  </details>

  <div class="exercise-editor">
    <label for="student-prompt-nb-m4e1">Your Assessment:</label>
    <textarea id="student-prompt-nb-m4e1" class="student-prompt" rows="16" placeholder="For EACH case, provide:

1. IDENTIFICATION: What is this finding called? Describe what you observe.

2. BENIGN vs CONCERNING: Is this benign, or does it require intervention?

3. SURGICAL URGENCY: Does this need immediate surgery, elective surgery, or no surgery?

4. NATURAL HISTORY: What is the expected course if observation is appropriate?

5. MANAGEMENT: What specific management would you recommend?

6. PARENT EDUCATION: What would you tell the parents about this finding?

7. RED FLAGS: What signs would warrant urgent re-evaluation?

Be specific about findings and implications!"></textarea>
    <div class="editor-hints">
      Tip: Remember - umbilical granulomas are benign, but omphaloceles and gastroschisis need surgery. Single umbilical artery warrants screening.
    </div>
  ...
  <div class="exercise-feedback" style="display: none;">
    ...
    <div class="exercise-actions">
      ...
      <button class="btn-next-exercise" onclick="document.getElementById('nb_m4e2').scrollIntoView({behavior: 'smooth'});">Next Exercise →</button>
    </div>
  </div>
...
<script>
  (function() {
    ...
    const exerciseConfig = exercises.newborn_m4e1;
    const scenario = scenarios[exerciseConfig.scenario];

    document.getElementById('transcript-content-nb-m4e1').textContent = scenario.scenario;

    const exercise = new NewbornExercise('nb_m4e1', {
      ...exerciseConfig,
...
<div class="course-exercise" id="nb_m4e2">

  <div class="exercise-header">
    <h3 class="exercise-title">Exercise 4.2: Hip Exam and Developmental Dysplasia Screening</h3>
    <div class="exercise-meta">
      <span class="exercise-difficulty difficulty-intermediate">Intermediate</span>
      <span class="exercise-time">⏱ 20 minutes</span>
    </div>
  ...
  <div class="exercise-goal">
    <h3>Your Challenge</h3>
    <p>Review clinical cases with hip examination findings. Describe proper examination technique, identify positive versus negative findings, recognize DDH risk factors, and determine the need for ultrasound or orthopedic referral.</p>
  </div>

  <details class="exercise-transcript">
    <summary>View Hip Examination Cases</summary>
    <div class="transcript-content" id="transcript-content-nb-m4e2">Loading cases...</div>
  </details>

  <div class="exercise-editor">
    <label for="student-prompt-nb-m4e2">Your Assessment:</label>
    <textarea id="student-prompt-nb-m4e2" class="student-prompt" rows="16" placeholder="For EACH case, provide:

1. EXAMINATION TECHNIQUE: Describe how you would perform Ortolani and Barlow maneuvers.

2. FINDINGS: What are the key examination findings in this case? (Ortolani+/-, Barlow+/-, abduction, asymmetry)

3. DDH RISK FACTORS: Identify any risk factors for developmental dysplasia present in this case.

4. INTERPRETATION: Does this exam suggest normal hips or DDH concern?

5. IMAGING DECISION: Does this infant need hip ultrasound? If yes, when?

6. REFERRAL: Does this case need orthopedic referral? What should you tell the parents?

7. FOLLOW-UP PLAN: What is your plan for this infant?

Be thorough about technique and clinical reasoning!"></textarea>
    <div class="editor-hints">
      Tip: Ortolani = reduction of dislocated hip (clunk with abduction). Barlow = dislocation from reduced hip. Both are palpable clunks, not clicks.
    </div>
    <div class="hint-display"></div>
    <div class="error-message"></div>
    <button class="btn-run-exercise">Submit Assessment</button>
  ...
  <div class="exercise-feedback" style="display: none;">
    ...
    <div class="exercise-actions">
      <button class="btn-retry">Try Again</button>
      <button class="btn-next-exercise" onclick="document.getElementById('nb_m4e3').scrollIntoView({behavior: 'smooth'});">Next Exercise →</button>
    </div>
  </div>
...
<script>
  (function() {
    ...
    const exerciseConfig = exercises.newborn_m4e2;
    const scenario = scenarios[exerciseConfig.scenario];

    document.getElementById('transcript-content-nb-m4e2').textContent = scenario.scenario;

    const exercise = new NewbornExercise('nb_m4e2', {
      ...exerciseConfig,
      scenario: scenario.scenario,
      expectedFindings: scenario.expected_findings
    });
...
<div class="course-exercise" id="nb_m4e3">

  <div class="exercise-header">
    <h3 class="exercise-title">Exercise 4.3: Extremity and Spine Examination</h3>
    <div class="exercise-meta">
      <span class="exercise-difficulty difficulty-intermediate">Intermediate</span>
      <span class="exercise-time">⏱ 20 minutes</span>
    </div>
  ...
  <div class="exercise-goal">
    <h3>Your Challenge</h3>
    <p>Review images and descriptions of extremity and spine findings. Assess each finding by differentiating normal variations from true abnormalities, examining spine integrity and cutaneous markers, assessing digit abnormalities, and determining need for further evaluation or referral.</p>
  </div>

  <details class="exercise-transcript">
    <summary>View Extremity and Spine Cases</summary>
    <div class="transcript-content" id="transcript-content-nb-m4e3">Loading cases...</div>
  </details>

  <div class="exercise-editor">
    <label for="student-prompt-nb-m4e3">Your Assessment:</label>
    <textarea id="student-prompt-nb-m4e3" class="student-prompt" rows="16" placeholder="For EACH case, provide:

1. FINDING IDENTIFICATION: What is this finding called? Describe exactly what you observe.

2. NORMAL vs ABNORMAL: Is this a normal variation, benign finding, or pathological?

3. FLEXIBILITY ASSESSMENT: If a deformity, can it be passively corrected? (If applicable)

4. ASSOCIATED CONDITIONS: Could this be associated with genetic syndromes or other anomalies?

5. WORKUP NEEDED: Does this need imaging (ultrasound, X-rays, MRI)? What type and urgency?

6. SPECIALIST REFERRAL: Does this need referral to orthopedics, neurosurgery, genetics, or another specialist?

7. PROGNOSIS: What is the expected outcome? Will this resolve spontaneously or require intervention?

8. PARENT COUNSELING: How would you explain this finding to the parents?

Consider both short-term and long-term implications!"></textarea>
    <div class="editor-hints">
      Tip: Positional deformities are flexible and improve with observation. Structural abnormalities are rigid. Sacral dimples need imaging only if concerning features present.
    </div>
    <div class="hint-display"></div>
    <div class="error-message"></div>
    <button class="btn-run-exercise">Submit Assessment</button>
  ...
  <div class="exercise-feedback" style="display: none;">
    ...
    <div class="exercise-actions">
      <button class="btn-retry">Try Again</button>
      <a href="/courses/newborn-exam/module-5/" class="btn-next-exercise">Continue to Module 5 →</a>
    </div>
  </div>
...
<script>
  (function() {
    ...
    const exerciseConfig = exercises.newborn_m4e3;
    const scenario = scenarios[exerciseConfig.scenario];

    document.getElementById('transcript-content-nb-m4e3').textContent = scenario.scenario;

    const exercise = new NewbornExercise('nb_m4e3', {
      ...exerciseConfig,
      scenario: scenario.scenario,
      expectedFindings: scenario.expected_findings
    });
...
Identifying common abdominal findings and masses
Recognizing umbilical anomalies and their management
Performing and interpreting hip dysplasia screening maneuvers
Differentiating DDH risk factors and determining imaging needs
Examining the spine and recognizing cutaneous markers
Distinguishing positional deformities from structural abnormalities
Knowing when specialist referral is needed

### Key Takeaways

1. **Ortolani vs Barlow** - Ortolani detects reduction of dislocated hip; Barlow detects dislocatability. Both are palpable clunks, not subtle findings.

2. **DDH Screening Timeline** - Most sensitive in newborn period (before 6-8 weeks); ultrasound becomes more important for screening and diagnosis after 4-6 weeks.

3. **Risk Factors Matter** - Female, firstborn, breech presentation, and family history increase DDH risk and should prompt ultrasound even with normal exam.

4. **Umbilical Findings Vary Widely** - From completely benign (cord care, separation) to urgent (gastroschisis, omphalocele). Know which need immediate surgical consultation.

5. **Positional vs Structural** - Positional deformities are flexible and improve with parental positioning/exercise. Structural abnormalities require specialist intervention.

6. **Cutaneous Markers Matter** - Simple sacral dimple is usually benign, but hairy patches, deep pits, or associated asymmetry warrant imaging to rule out spinal dysraphism.

7. **Digit Abnormalities Assessment** - Polydactyly/syndactyly require evaluation for associated syndromes. Isolated postaxial polydactyly has better prognosis than preaxial.
...
<div style="text-align: center; margin: 3rem 0;">
  <a href="/courses/newborn-exam/module-5/" class="btn-primary" style="display: inline-block; padding: 1rem 2rem; font-size: 1.125rem; background: #2563eb; color: white; text-decoration: none; border-radius: 0.5rem; font-weight: 600;">Continue to Module 5 →</a>
</div>
