...
<div class="hero">
    <div class="container">
        ...
        <p class="hero-subtitle">
            ...
            This tool guides you from aim setting to your first PDSA cycle. (Note: Not affiliated with IHI, please visit https://www.ihi.org/ to learn more from directly from the source)
        </p>
    </div>
</div>
