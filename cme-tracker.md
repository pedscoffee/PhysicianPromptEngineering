...
<!-- PWA Meta Tags -->
<link rel="manifest" href="{{ '/cme-manifest.json' | relative_url }}">
<meta name="theme-color" content="#059669">
<meta name="apple-mobile-web-app-capable" content="yes">
<meta name="apple-mobile-web-app-status-bar-style" content="black-translucent">
<meta name="apple-mobile-web-app-title" content="CME Tracker">
...
<!-- PWA Install Banner -->
<div id="pwaInstallBanner" style="display: none; background: linear-gradient(135deg, #059669 0%, #047857 100%); border-radius: 8px; padding: 15px; margin-bottom: 20px;">
    <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 10px;">
        <div style="display: flex; align-items: center; gap: 12px;">
            ...
            <div>
                <strong style="color: white;">Install CME Tracker</strong>
                <p style="margin: 0; color: rgba(255,255,255,0.85); font-size: 0.85em;">Add to your home screen for quick access</p>
            </div>
        </div>
        <div style="display: flex; gap: 10px;">
            <button id="pwaInstallBtn" onclick="installPWA()" style="background: white; color: #059669; border: none; padding: 10px 20px; border-radius: 6px; font-weight: 600; cursor: pointer;">📲 Install</button>
