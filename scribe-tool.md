...
<div class="container">
    ...
    <div class="warning-box" id="browser-warning">
        ...
        <ul>
            ...
            <li><strong>First-time setup:</strong> Downloads ~2.5GB (Whisper Small 500MB + Phi-3.5 2GB), cached permanently</li>
...
<script type="module">
    ...
    const WHISPER_MODEL = "Xenova/whisper-small"; // Upgraded for better accuracy with manageable size
...
MEDICAL NOTE:`,
    ...
    window.initializeModels = async function() {
        ...
        try {
            ...
            statusDetails.textContent = 'Downloading ~500MB... This may take 2-5 minutes (one-time download).';
