...
<style>
    ...
    @media (prefers-color-scheme: dark) {
        ...
        /* Containers & Cards */
        .container, .card, .variable-item, .chart-container, .stat-card {
            background-color: #1f2937;
            border-color: #374151;
            color: #f9fafb;
        }
        ...
        .variable-item, .data-table th, .data-table tr:hover {
            background-color: #111827;
        }

        /* Text Colors */
        h1, h2, h3, h4, h5, h6,
        .project-title, .chart-title, .stat-value,
        .form-label, .variable-header strong {
            color: #f9fafb;
        }

        .project-description, .project-stats, .stat-label,
        .no-projects h2, .no-projects p {
            color: #9ca3af;
        }
