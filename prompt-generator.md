...
- Use 8-space indentation"></textarea>
    ...
    <div class="support-section">
        ...
        <p>This project and this tool could have been a product or a start up like most AI related apps right now.  My goal instead is to create a resource to give back to the medical community.  Use it for free!
        
        If this tool has helped streamline your clinical workflow, consider supporting the project with a small tip. Your support helps keep this resource free and ad-free for all clinicians. Students: Don't even think about it.</p>
